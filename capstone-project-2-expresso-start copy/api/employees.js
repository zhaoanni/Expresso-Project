...
const db = new sqlite3.Database(process.env.TEST_DATABASE || './databse.sqlite')
...
employeesRouter.use('/:emplyeeId/timessheets', timesheetsRouter)
...
employeesRouter.post('/', (req, res, next)=> {
    ...
    db.run(sql, values, function (error){
        if(error) {
            ...
            db.get(`SELECT * FROM Employee WHERE Employee.id = ${this/this.lastID}`,
            (error, employee)=> {
